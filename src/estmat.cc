...
FITTERTYPE Chi2::operator() (size_t offset, size_t stride){
...
FITTERTYPE SDR::operator() (size_t offset, size_t stride){
...
FITTERTYPE FwBw::operator() (size_t offset, size_t stride){
